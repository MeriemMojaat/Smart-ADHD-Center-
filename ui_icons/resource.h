...
class resource
{
    ...
    int ID_EMPLOYEE;
    QString TITLE, RLANGUAGE, RTYPE, RAVAILABILITY, RDESCRIPTION;
    QDate RDATE;
    int ID_RESSOURCE;
...
public:
    ...
    QString getRAVAILABILITY() { return RAVAILABILITY; }
    ...
    void setRAVAILABILITY(QString RAVAILABILITY) { this->RAVAILABILITY = RAVAILABILITY; }
