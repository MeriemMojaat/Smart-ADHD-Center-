...
resource::resource(int ID_RESSOURCE, QString TITLE, QString RLANGUAGE, QString RTYPE, QString RAVAILABLILITY, QDate RDATE, QString RDESCRIPTION, int ID_EMPLOYEE)
{
    this->ID_RESSOURCE = ID_RESSOURCE;
    this->TITLE = TITLE;
    this->RLANGUAGE = RLANGUAGE;
    this->RTYPE = RTYPE;
    this->RAVAILABLILITY = RAVAILABLILITY;
    this->RDATE = RDATE;
...
bool resource::Create()
{
    ...
    query.prepare("insert into RESSOURCE_LIBRARY (ID_RESSOURCE, TITLE, RLANGUAGE, RTYPE, RAVAILABLILITY, RDATE, RDESCRIPTION, ID_EMPLOYEE) values (:ID_RESSOURCE, :TITLE, :RLANGUAGE, :RTYPE, :RAVAILABLILITY, :RDATE, :RDESCRIPTION,(SELECT ID_EMPLOYEE FROM Employee WHERE ID_EMPLOYEE=:ID_EMPLOYEE ) )");
    ...
    query.bindValue(":RAVAILABLILITY", RAVAILABLILITY);
...
QSqlQueryModel* resource::Read()
{
    ...
    model->setHeaderData(4, Qt::Horizontal, QObject::tr("RAVAILABLILITY"));
...
bool resource::Update()
{
    bool execStatus = false;
       ...
       query.prepare("UPDATE RESSOURCE_LIBRARY SET TITLE=:TITLE ,RLANGUAGE=:RLANGUAGE ,RTYPE=:RTYPE ,RAVAILABLILITY=:RAVAILABLILITY ,RDATE=:RDATE ,RDESCRIPTION=:RDESCRIPTION,ID_EMPLOYEE=:ID_EMPLOYEE WHERE ID_RESSOURCE=:ID_RESSOURCE");
...
QSqlQueryModel* resource::sortavailability()
{
    ...
    model->setQuery("select * from RESSOURCE_LIBRARY ORDER BY RAVAILABLILITY");
